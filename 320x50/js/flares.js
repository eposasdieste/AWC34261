...
var flares_x_start = -50,
    flares_to_x = 220;
//flares y positions
var flare_top_y_pos = -6,
    flare_btm_y_pos = 37;
...
function flares(dur){
  ...
  // bottom flare
  TweenLite.to('#flare', dur/4, {delay:0.35, alpha:1,onComplete:
    function(){
      TweenLite.to('#flare', 3*(dur/4), {alpha:0});
    }
  });
  TweenLite.to('#flare', dur, {delay:0.35, x:flares_to_x,ease:Power1.easeOut,onComplete:
    function(){
